...
const TRACKS = {
    // 🥚 알 탭 v3: 오르골 같은 따뜻+반짝 (Ab major, ~105 BPM)
    egg: {
        bpm: 105,
        melody: {
            wave: 'square',
            ...
            notes: [
                // A: 통통 튀는 오르골 도입
                ['Ab5', 0.5], ['C6', 0.5], ['Eb6', 1], ['C6', 0.5], ['Ab5', 0.5],
                ['Bb5', 1], ['C6', 0.5], ['Bb5', 0.5], ['Ab5', 1],
                // B: 바운스하며 상승
                ['Eb5', 0.5], ['Ab5', 0.5], ['C6', 0.5], ['Eb6', 0.5],
                ['Db6', 1], ['C6', 0.5], ['Bb5', 0.5], ['Ab5', 1], ['_', 0.5],
                // C: 새로운 모티프 — 살짝 장난스럽게
                ['C6', 0.5], ['Db6', 0.25], ['C6', 0.25], ['Bb5', 0.5], ['Ab5', 0.5],
                ['Bb5', 0.5], ['C6', 0.5], ['Eb6', 1], ['Db6', 0.5], ['C6', 0.5],
                // D: 밝고 해맑은 클라이맥스
                ['Eb6', 0.5], ['Db6', 0.5], ['C6', 0.5], ['Ab5', 0.5],
                ['Bb5', 1], ['Ab5', 0.5], ['Eb5', 0.5], ['Ab5', 1.5], ['_', 0.5],
            ]
        },
        bass: {
            wave: 'triangle',
            volume: 0.05,
            notes: [
                ['Ab3', 1], ['Eb3', 0.5], ['Ab3', 0.5], ['Db4', 1], ['Ab3', 0.5], ['Eb3', 0.5],
                ['Bb3', 1], ['Eb3', 0.5], ['Bb3', 0.5], ['Ab3', 1], ['Eb3', 0.5], ['Ab3', 0.5],
                ['Db4', 1], ['Ab3', 0.5], ['Db4', 0.5], ['Eb4', 1], ['Bb3', 0.5], ['Eb3', 0.5],
                ['Ab3', 1], ['C4', 0.5], ['Ab3', 0.5], ['Eb3', 0.5], ['Bb3', 0.5], ['Ab3', 1],
            ]
        },
        arp: {
            wave: 'square',
            ...
            notes: [
                ...
                ['Db5', 0.5], ['F5', 0.5], ['Ab5', 0.5], ['F5', 0.5],
                ['Eb5', 0.5], ['Ab5', 0.5], ['C5', 0.5], ['Eb5', 0.5],
                ['Bb4', 0.5], ['Db5', 0.5], ['F5', 0.5], ['Db5', 0.5],
                ['Ab4', 0.5], ['Eb5', 0.5], ['Ab5', 0.5], ['Eb5', 0.5],
                ['Db5', 0.5], ['Ab5', 0.5], ['F5', 0.5], ['Db5', 0.5],
                ['C5', 0.5], ['Eb5', 0.5], ['Ab5', 0.5], ['Eb5', 0.5],
    ...
    // 🎵 리듬게임: 박진감 넘치는 보스전 느낌 (E minor, 150 BPM)
    rhythm: {
        bpm: 150,
        melody: {
            wave: 'square',
            ...
            notes: [
                // A: 강렬한 도입
                ['B5', 0.5], ['E5', 0.25], ['E5', 0.25], ['G5', 0.5], ['A5', 0.5],
                ['B5', 0.5], ['B5', 0.25], ['A5', 0.25], ['G5', 0.5], ['E5', 0.5],
                // B: 가속 패턴
                ['E5', 0.25], ['G5', 0.25], ['A5', 0.25], ['B5', 0.25], ['C6', 0.5], ['B5', 0.5],
                ['A5', 0.5], ['G5', 0.25], ['A5', 0.25], ['B5', 0.5], ['E5', 0.5],
                // C: 클라이맥스
                ['E6', 0.5], ['D6', 0.25], ['E6', 0.25], ['B5', 0.5], ['A5', 0.5],
                ['G5', 0.5], ['A5', 0.5], ['B5', 1],
                // D: 루프 이음
                ['A5', 0.25], ['B5', 0.25], ['C6', 0.25], ['D6', 0.25], ['E6', 0.5], ['D6', 0.5],
                ['B5', 0.5], ['G5', 0.5], ['E5', 0.5], ['_', 0.5],
            ]
        },
        bass: {
            wave: 'sawtooth',
            ...
            notes: [
                ...
                ['E3', 0.5], ['E3', 0.5], ['G3', 0.5], ['G3', 0.5],
                ['A3', 0.5], ['A3', 0.5], ['B3', 0.5], ['B3', 0.5],
                ['C3', 0.5], ['C3', 0.5], ['D3', 0.5], ['D3', 0.5],
                ['E3', 0.5], ['E3', 0.5], ['E3', 0.5], ['E3', 0.5],
                ['A3', 0.5], ['G3', 0.5], ['E3', 0.5], ['D3', 0.5],
        ...
        arp: {
            ...
            notes: [
                ...
                ['D4', 0.25], ['G4', 0.25], ['B4', 0.25], ['D5', 0.25],
                ['E4', 0.25], ['G4', 0.25], ['B4', 0.25], ['E5', 0.25],
                ['G4', 0.25], ['B4', 0.25], ['E5', 0.25], ['G5', 0.25],
                ['A4', 0.25], ['C5', 0.25], ['E5', 0.25], ['A5', 0.25],
                ['B4', 0.25], ['E5', 0.25], ['G5', 0.25], ['B5', 0.25],
                ['C5', 0.25], ['E5', 0.25], ['G5', 0.25], ['E5', 0.25],
                ['D5', 0.25], ['G4', 0.25], ['B4', 0.25], ['D5', 0.25],
                ['E4', 0.25], ['B4', 0.25], ['E5', 0.25], ['B4', 0.25],
                ['E4', 0.25], ['A4', 0.25], ['C5', 0.25], ['A4', 0.25],
                ['G4', 0.25], ['B4', 0.25], ['E5', 0.25], ['B4', 0.25],
                ['A4', 0.25], ['C5', 0.25], ['E5', 0.25], ['C5', 0.25],
                ['D4', 0.25], ['G4', 0.25], ['B4', 0.25], ['G4', 0.25],
                ['E4', 0.25], ['G4', 0.25], ['B4', 0.25], ['E5', 0.25],
            ]
        }
    },
